    ...
    <section id="menu-container">
        <div id="menu-box">
            ...
            <ul class="menu-subset-list" id="menu-list-manage">
                <li class="menu-subset-list-header">Manage</li>
                <a href="/courses"><li class="menu-subset-list-item" <c:if test="${context == 'courses'}"> class="menu-selected-page" </c:if>>Courses</li></a>
                <a href="/faculty"><li class="menu-subset-list-item" <c:if test="${context == 'faculty'}"> class="menu-selected-page" </c:if>>Faculty</li></a>
            </ul>
            <!-- Actions Menu -->
