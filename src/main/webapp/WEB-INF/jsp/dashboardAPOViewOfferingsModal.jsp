	      	...
	      	<div class ="col-md-12">
		        <div class="col-md-4 form-group">
		        	<label for="searchOfferingVO">Search Course</label>
		          	<input type="text" class="form-control" id="searchOfferingVO" placeholder="Search Course...">
		        </div>
		        <div class="col-md-3 form-group">
		          <label for="statusVODropdown">Status</label>
		            <select class="form-control" id="statusVODropdown" onChange="">
					    <option selected>All</option>
					</select>
	       		</div>
	       		<div class="col-md-3 form-group">
		          <label for="batchVODropdown">Batch</label>
		            <select class="form-control" id="batchVODropdown" onChange="">
					    <option selected>All</option>
					</select>
	       		</div>
       		</div>
       		<div class ="col-md-12">
		          ...
		          <label for="roomTypeVODropdown">Room Type</label>
		            <select class="form-control" id="roomTypeVODropdown" onChange="">
					    <option selected>All</option>
					</select>
	       		</div>
		        <div class="col-md-3 form-group">
		          <label for="timeBlockVODropdown">Time Block</label>
		            <select class="form-control" id="timeBlockVODropdown" onChange="">
					    <option selected>All</option>
					</select>
	       		</div>
	       		<div class="col-md-6 form-group">
	       			...
	       			<br>
					<label class="checkbox-inline"><input type="checkbox" data-toggle="toggle" data-size="mini" data-onstyle="success" data-style="ios" data-on="M" data-off="M" id="toggleMVO" value="" checked></label>
					<label class="checkbox-inline"><input type="checkbox" data-toggle="toggle" data-size="mini" data-onstyle="success" data-style="ios" data-on="T" data-off="T" id="toggleTVO" value="" checked></label>
					<label class="checkbox-inline"><input type="checkbox" data-toggle="toggle" data-size="mini" data-onstyle="success" data-style="ios" data-on="W" data-off="W" id="toggleWVO" value="" checked></label>
					<label class="checkbox-inline"><input type="checkbox" data-toggle="toggle" data-size="mini" data-onstyle="success" data-style="ios" data-on="H" data-off="H" id="toggleHVO" value="" checked></label>
					<label class="checkbox-inline"><input type="checkbox" data-toggle="toggle" data-size="mini" data-onstyle="success" data-style="ios" data-on="F" data-off="F" id="toggleFVO" value="" checked></label>
					<label class="checkbox-inline"><input type="checkbox" data-toggle="toggle" data-size="mini" data-onstyle="success" data-style="ios" data-on="S" data-off="S" id="toggleSVO" value="" checked></label>
	       		</div>
       		</div>
	      </div>
